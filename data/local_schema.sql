-- Quantum Trading AI Local Database Schema
-- Simplified for local PostgreSQL (without Supabase RLS)
...
DROP TRIGGER IF EXISTS update_leads_updated_at ON lead_scores;
